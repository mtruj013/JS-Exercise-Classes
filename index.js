...
// const hubs = new Person({
//   name: "Alberto",
//   age: 28
// });

// console.log(hubs.toString());
...
const newOne = new Car('toyota', 20);

console.log(newOne.fill(50));
console.log(newOne.drive(2));
...
class Instructor extends Lambdasian{
  ...
  demo(str){
    return `Today we are learning abuot ${str}`
  }
